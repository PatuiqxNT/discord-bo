...
client.login(process.env.OTIyODgyNjE2OTY3OTgzMTY0.YcH7ag._W_cEugBILRIuqB6W8FyTNwloS8);
...
client.on("message", async (msg) => {
  ...
  if (tokens[0] === "!gif") {
    ...
    const url = `https://api.tenor.com/v1/search?q=${keywords}&key=${process.env.D31V2SJX9E9W}&limit=10`;
    //FETCH THE RESULTS
